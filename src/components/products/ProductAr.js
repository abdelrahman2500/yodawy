                  ...
                  <div className="row">
                    ...
                    <div className="col-12 col-md-8">
                      <div className="row">
                        ...
                        <div className="col-12 py-2">
                          <Link to="/yodawy/shop" className="text-decoration-none" data-bs-dismiss="modal" onClick={()=> context.setFilterd(context.products.filter(p => p.brandAr == product.brandAr))}>{product.brandAr}</Link>
                        </div>
